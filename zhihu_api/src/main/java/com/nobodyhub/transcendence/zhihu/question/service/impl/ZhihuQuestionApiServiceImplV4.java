...
public class ZhihuQuestionApiServiceImplV4 implements ZhihuQuestionApiService {
    ...
    @Override
    public List<ZhihuApiAnswer> getAnswersForQuestion(String questionId) {
    ...
    @Override
    public List<ZhihuApiAnswer> getAnswersForMember(String token) {
        List<ZhihuApiAnswer> answers = Lists.newArrayList();
        Optional<ZhihuAnswerList> answerList = doFetch(
            zhihuUrlConvertService.convert(
    ...
    private void fetchMoreAnswers(ZhihuAnswerList answerList,
                                  @NotNull List<ZhihuApiAnswer> answers) {
